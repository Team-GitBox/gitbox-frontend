...
const FileIcon = ({ type }) => {
  switch (type) {
    ...
    case 'PNG':
      return <img src="img/png.png" alt="png Icon" width="50" height="50" />;
    case 'JPG':
    case 'JPEG':
      return <img src="img/jpg.png" alt="jpg Icon" width="50" height="50" />;
    case 'TXT':
      return <img src="img/txt.png" alt="txt Icon" width="50" height="50" />;
    case 'DOC':
    case 'DOCX':
      return <img src="img/docs.png" alt="docs Icon" width="50" height="50" />;
    case 'XLS':
    case 'XLSX':
      return <img src="img/xls.png" alt="xls Icon" width="50" height="50" />;
    case 'PPT':
    case 'PPTX':
      return <img src="img/ppt.png" alt="ppt Icon" width="50" height="50" />;
    case 'ZIP':
      return <img src="img/zip.png" alt="zip Icon" width="50" height="50" />;
    default:
      return <img src="img/file.png" alt="file Icon" width="50" height="50" />;
  }
};
  ...
  const getFileUI = () => {
    ...
    return (
      <>
        <div className="grid-container2">
          {parentFolderId != null && (
            <div className="grid-item" onClick={() => changeCurrentFolder(parentFolderId)}>
              <img
                src="img/back.png"
                alt="folder"
                className="folder"
          ...
          {folders.length != 0 && (
            folders.map((folder, index) => (
              <div className="grid-item" key={index} onClick={() => popupOpenFolder(folder.id)} >
          ...
          {files.length != 0 && (
            files.map((fileInfo, index) => (
              ...
              <div className="grid-item" key={index} onDoubleClick={() => handleDoubleClick(fileInfo.id, fileInfo.name)} onDrop={(e) => onDropa(e, fileInfo.id)} onDragOver={(e) => e.preventDefault()}>
                ...
                <div className="item-container">
                  <div className="item-contain">
                    <div className="con" onClick={() => lookFileInfo(fileInfo.id)}>
                      <FileIcon className='icon' type={fileInfo.type} />
                    </div>
                    <div className="item-con">
                      <div style={{ width: '5px', height: '5px', margin: '4px', padding: '5px', backgroundColor: tagColors[fileInfo.tag], display: 'flex', borderRadius: '50%', flexDirection: 'row', textAlign: 'center' }}></div>
        ...
        {isLook && (
          <div className="popup-infoinfo">
            <div className="popup-info">
              <FileIcon style={{ borderRadius: '5px' }} type={fileType} />
